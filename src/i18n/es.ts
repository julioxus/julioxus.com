export default {
  ...
  'services.subtitle': 'Soluciones integrales de ciberseguridad adaptadas a tus necesidades',
  'services.pentest.title': 'Pentesting',
  'services.pentest.desc': 'Evaluaciones de seguridad exhaustivas de aplicaciones web, APIs, apps móviles, infraestructura cloud y entornos Active Directory. Identifica vulnerabilidades antes que los atacantes.',
  'services.pentest.items': 'Testing Web y API,Seguridad de Apps Móviles (iOS/Android),Seguridad Cloud (AWS y GCP),Pentesting de Active Directory y Redes,Gestión de Programas de Bug Bounty',
  'services.consulting.title': 'Consultoría de Seguridad',
  'services.consulting.desc': 'Orientación estratégica de seguridad para integrar la seguridad en tu ciclo de desarrollo. Desde revisión de arquitectura hasta preparación para cumplimiento normativo.',
  'services.consulting.items': 'Diseño de Arquitectura Segura,Modelado de Amenazas y Revisión de Código,Integración DevSecOps en Pipelines,Cumplimiento ISO 27001 y SOC 2,Respuesta a Incidentes de Seguridad',
  'services.secdev.title': 'Desarrollo Seguro',
  ...
  // Engagement models
  'services.engagement.title': 'Modelos de Colaboración',
  'services.engagement.subtitle': 'Colaboración flexible adaptada a tus necesidades',
  'services.engagement.project.title': 'Por Proyecto',
  'services.engagement.project.desc': 'Compromisos con alcance definido y entregables claros. Ideal para pentests, auditorías y evaluaciones puntuales.',
  'services.engagement.retainer.title': 'Retainer',
  'services.engagement.retainer.desc': 'Colaboración de seguridad continua con una bolsa mensual de horas. Perfecto para monitorización y asesoramiento continuo.',
  'services.engagement.daily.title': 'Tarifa Diaria',
  'services.engagement.daily.desc': 'Consultoría flexible por día para talleres, sesiones de formación y compromisos a corto plazo.',
  ...
  'ai.benefit2.desc': 'Testing especializado de modelos de machine learning contra ataques adversariales, envenenamiento de datos, extracción de modelos y vulnerabilidades de prompt injection.',
  ...
  'certs.subtitle': 'Credenciales reconocidas por la industria que validan una profunda experiencia técnica',

  // Skills
  'skills.title': 'Habilidades y Herramientas',
  'skills.security': 'Testing de Seguridad',
  'skills.appsec': 'Seguridad de Aplicaciones',
  ...
  // Speaking
  'speaking.title': 'Ponencias y Comunidad',
  'speaking.subtitle': 'Contribuidor activo a la comunidad de ciberseguridad',
  'speaking.cybercamp': 'Ponente en Cybercamp, uno de los mayores congresos de ciberseguridad de España organizado por INCIBE.',
  'speaking.navaja': 'Ponente en Navaja Negra, un reconocido congreso español de seguridad centrado en investigación de seguridad ofensiva.',
  'speaking.bugbounty': 'Investigador activo de bug bounty en Intigriti, contribuyendo a la seguridad de plataformas importantes.',
  'speaking.ctf': 'Participante regular en competiciones CTF, manteniendo habilidades afiladas en seguridad ofensiva.',

  // Contact
  'contact.title': 'Aseguremos Tu Organización',
  'contact.subtitle': '¿Listo para fortalecer tu postura de seguridad? Contacta para una consulta inicial gratuita.',
  'contact.name': 'Nombre',
  'contact.email': 'Email',
  'contact.company': 'Empresa',
  'contact.service': 'Servicio de Interés',
  'contact.service.pentest': 'Pentesting',
  'contact.service.consulting': 'Consultoría de Seguridad',
  'contact.service.training': 'Formación y Cursos',
  'contact.service.other': 'Otro',
  'contact.message': 'Mensaje',
  'contact.send': 'Enviar Mensaje',
  'contact.or': 'O contacta directamente en',
  ...
  // Blog
  'blog.title': 'Blog',
  'blog.subtitle': 'Perspectivas sobre ciberseguridad, pentesting con IA y desarrollo seguro',
